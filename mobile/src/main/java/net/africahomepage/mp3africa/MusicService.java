...
import net.africahomepage.mp3africa.playback.Playback;
import net.africahomepage.mp3africa.playback.PlaybackManager;
import net.africahomepage.mp3africa.playback.QueueManager;
import net.africahomepage.mp3africa.ui.NowPlayingActivity;
...
public class MusicService extends MediaBrowserServiceCompat implements
    ...
    public static final String EXTRA_CONNECTED_CAST = "net.africahomepage.mp3africa.CAST_NAME";
    // The action of the incoming Intent indicating that it contains a command
    // to be executed (see {@link #onStartCommand})
    public static final String ACTION_CMD = "net.africahomepage.mp3africa.ACTION_CMD";
