...
import net.africahomepage.mp3africa.ui.MusicPlayerActivity;
import net.africahomepage.mp3africa.utils.LogHelper;
import net.africahomepage.mp3africa.utils.ResourceHelper;
...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public static final String ACTION_PAUSE = "net.africahomepage.mp3africa.pause";
    public static final String ACTION_PLAY = "net.africahomepage.mp3africa.play";
    public static final String ACTION_PREV = "net.africahomepage.mp3africa.prev";
    public static final String ACTION_NEXT = "net.africahomepage.mp3africa.next";
    public static final String ACTION_STOP_CASTING = "net.africahomepage.mp3africa.stop_cast";
