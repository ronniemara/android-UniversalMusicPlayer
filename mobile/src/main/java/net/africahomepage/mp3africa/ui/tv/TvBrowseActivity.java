 ...
 */
package net.africahomepage.mp3africa.ui.tv;
...
public class TvBrowseActivity extends FragmentActivity
    ...
    public static final String SAVED_MEDIA_ID="net.africahomepage.mp3africa.MEDIA_ID";
    public static final String BROWSE_TITLE = "net.africahomepage.mp3africa.BROWSE_TITLE";
