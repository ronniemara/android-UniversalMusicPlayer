...
package net.africahomepage.mp3africa.utils;

import android.os.Bundle;
import android.support.v4.media.MediaMetadataCompat;
import android.support.v4.media.session.MediaSessionCompat;

import net.africahomepage.mp3africa.VoiceSearchParams;
import net.africahomepage.mp3africa.model.MusicProvider;

import java.util.ArrayList;
import java.util.List;

import static net.africahomepage.mp3africa.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_GENRE;
import static net.africahomepage.mp3africa.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_SEARCH;
